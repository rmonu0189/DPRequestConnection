...
public enum DPHTTPStatusCode: Int {
    case `continue` = 100,
    ...
    init(statusCode: Int) {
        self = DPHTTPStatusCode(rawValue: statusCode) ?? .unknownStatus
    }
    ...
    public var statusDescription: String {
        ...
        case .noInternetConnection:
            return "Could not connect - no internet connection. Please check your wifi or internet connection and try again."
        default:
